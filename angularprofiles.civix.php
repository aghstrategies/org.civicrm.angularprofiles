...
function _angularprofiles_civix_mixin_polyfill() {
...
function _angularprofiles_civix_civicrm_config(&$config = NULL) {
  ...
  _angularprofiles_civix_mixin_polyfill();
}
  ...
  if (empty($path)) {
    ...
    foreach ($menu as $key => &$entry) {
      if ($entry['attributes']['name'] == $first) {
        ...
        $found = _angularprofiles_civix_insert_navigation_menu($entry['child'], implode('/', $path), $item);
      }
    }
    return $found;
  }
 ...
 */
function _angularprofiles_civix_civicrm_entityTypes(&$entityTypes) {
